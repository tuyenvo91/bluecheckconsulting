...
export default function StaffCompanySettingsPage() {
  const [hasUnsavedChanges, setHasUnsavedChanges] = useState(false)

  return (
    <SettingsLayout role="staff" activeSection="company">
      {hasUnsavedChanges && (
      ...
      <CompanySection role="staff" onHasUnsavedChanges={setHasUnsavedChanges} />
    </SettingsLayout>
  )
}
